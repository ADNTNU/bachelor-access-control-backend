...
public interface CompanyRepository extends JpaRepository<Company, Long> {
   ...
   *
   * <p>This method retrieves a list of companies associated with the specified administrator ID.
   * The companies are filtered based on their administrator-company relationship and
   * if it is enabled and accepted.
   ...
   */
  @Query("""
          SELECT new no.ntnu.gr10.bacheloraccesscontrolbackend.company.dto.CompanySimpleDto(
                c.id,
                c.name
                )
                FROM Company c
   ...
   *
   * <p>This method retrieves a company by its name,
   * ensuring that the associated administrator companies are fetched eagerly.
   * </p>
   *
   ...
   *
   * <p>This method checks if a company with the specified name exists in the database.
   * </p>
   *
   * @param companyName the name of the company
